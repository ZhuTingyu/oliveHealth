...
public class PageRecyclerView extends RecyclerView {
    ...
    public PageRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRows = array.getInteger(R.styleable.PageRecyclerView_PagingRows, 0);
        mColums = array.getInteger(R.styleable.PageRecyclerView_PagingColums, 0);
        Drawable diver = array.getDrawable(R.styleable.PageRecyclerView_PagingDiver);
    ...
    public interface OnItemClickListener {
        void onItemClick(PageRecyclerView pageGridView, int position);
    }

    public static abstract class PagingAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {


        public PagingAdapter(int layoutResId, @Nullable List data) {
            super(layoutResId, data);
        }

        public PagingAdapter(@Nullable List data) {
            super(data);
        }

        public PagingAdapter(int layoutResId) {
            super(layoutResId);
        }
