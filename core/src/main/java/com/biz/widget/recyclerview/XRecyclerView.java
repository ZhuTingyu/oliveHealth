...
public class XRecyclerView extends FrameLayout {
    ...
    public static final int[] COLORS = {R.color.green_light, R.color.orange_light,
...
//    protected ViewStub mEmpty;
    ...
    protected View mMoreProgressView, mLoadingView;
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mProgressId = a.getResourceId(R.styleable.superrecyclerview_layout_progress, R.layout.loading_layout);
        } finally {
            a.recycle();
        }
    }
    ...
    private void initView() {
        ...
        mPtrLayout.setColorSchemeResources(R.color.green_light, R.color.orange_light,
                R.color.blue_light, R.color.red_light);
        if (mProgressId != 0) {
            mProgressView = inflate(getContext(), mProgressId, null);
            mProgressView.setBackgroundResource(R.color.color_fbfbfb);
        }

        if (mEmptyId != 0)
            mEmptyView = inflate(getContext(), mEmptyId, null);
    ...
    private void processOnMore() {
        ...
        if (((totalItemCount - lastVisibleItemPosition) <= ITEM_LEFT_TO_LOAD_MORE &&
                (totalItemCount - lastVisibleItemPosition) == 1 && totalItemCount > visibleItemCount)
                && !isLoadingMore) {
     ...
     *                                      Views. If adapters
     *                                      have stable ids and/or you want to animate the
     *                                      disappearing views, you may
    ...
    private void setAdapterInternal(RecyclerView.Adapter adapter, boolean compatibleWithPrevious,
        ...
        if (adapter instanceof BaseQuickAdapter){
            ...
            quickAdapter.setEmptyView(mProgressView);
...
//                                    getLastVisibleItemPosition(mRecycler.getLayoutManager()));
//                        }
//                }
//            , mRecycler);
        }
